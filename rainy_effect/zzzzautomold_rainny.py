...
def main():
    ...
    j = 3914  #j here means current image number that you want to annotation this will help rename the file
    ...
    def load_img(img_path):
        image = cv2.imread(r'D:\\Programming\\mycodes\\rainy_effect\\'+ img_path)
    ...
    def writeFiles(image_name,push_image):
        ...
        os.chdir(r"D:\\Programming\\mycodes\\Transformed_images")   #get into saving images directory

        cv2.imwrite(image_name, push_image)   # save image

        os.chdir(r"D:\\Programming\\mycodes\\rainy_effect")   #get into base images directory
